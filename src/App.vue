<template>
  ...
  <div style="width:1200px;">
    ...
    <el-button type="info">
      <a href="https://data.stats.gov.cn/" target="_blank" style="text-decoration: none">图三图四数据来源</a>
    </el-button>
  </div>
...
function createSummary() {
  ...
  summaryStr.value += "鉴于您是大学生，且就读于鳌山大专, 您的荷包可能不足以支撑您的消费, 建议您合理消费, 注意理财，多喝西北风。祝您生活如意, 步步高升。\n";
...
seasonData.value = [//采样自2023年青岛城镇居民季度支出
  {
    name: '住房支出',
    type: 'line',
    //stack: 'Total',
